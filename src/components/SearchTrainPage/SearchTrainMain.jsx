			...
			<div className="main-searchTickets-sort">
				...
				<div className="main-searchTickets-sort-order-right">
					...
					<div className="main-searchTickets-sort-onPage">показывать по:
						<button type = "button" className={"classFilterChoice" + (limitValue === 5 ? "Active" : "")} onClick={() => handleClickLimit(5)}>5</button>
						<button type = "button" className={"classFilterChoice" + (limitValue === 10 ? "Active" : "")} onClick={() => handleClickLimit(10)}>10</button>
						<button type = "button" className={"classFilterChoice" + (limitValue === 20 ? "Active" : "")} onClick={() => handleClickLimit(20)}>20</button>
					</div>
				</div>
			</div>
